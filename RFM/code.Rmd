...
#fviz_cluster(pam.res3, data = df_RFM2, ellipse.type = "convex", palette = "jco", repel = TRUE, ggtheme = theme_minimal())
...
```{r}
p=ggplot(df_RFM, aes(x=df_RFM$frequenci, y=df_RFM$log_monitery, color=Recency_group, shape=Recency_group)) + 
